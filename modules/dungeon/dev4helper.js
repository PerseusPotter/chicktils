...
const tickReg = reg('tick', () => stateIsAtDev4.set(dist(Player.getX(), 63) + dist(Player.getY(), 127) + dist(Player.getZ(), 35) < 3), 'dungeon/dev4helper').setEnabled(new StateProp(settings._dungeonDev4Helper).notequals('None').and(stateIsInBoss));
