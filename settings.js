...
export const props = {
  ...
  preferUseTracer: new Property('PreferUseTracer', page, ++sort, Property.Type.Toggle, false, { desc: 'when available, prefer to use a tracer rather than an arrow (is jittery and looks bad)' }),
  ...
  dungeonBoxMancerColor: new Property('DungeonBoxWithermancerColor', page, ++sort, Property.Type.Color, 0xFF0080FF),
